...
function truth() {
  ...
  function getTruth() {
    ...
    return truthQuestions[randomTruth]
  }
  getTruth()

  truthH1.innerText

  truthH1.appendChild(newDiv)
  document.querySelector('.todOptions').appendChild(newDiv)
}

// function dare() {
// }

truthButton.addEventListener('click', truth())
